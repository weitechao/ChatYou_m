...
public class CashValueSetMealControl {
	...
	@ResponseBody
	public void addOrUpdateCashValue(Integer t_id, int t_project_type, int t_gold, BigDecimal t_money, int t_end_type,
			int t_is_enable, String t_describe,String t_setMelName, HttpServletResponse response) {

		MessageUtil mu = this.cashValueSetMealService.addOrUpdateCashValue(t_id, t_project_type, t_gold, t_money,
				t_end_type, t_is_enable, t_describe,t_setMelName);
