...
public class VIPSetMealControl {
	...
	@ResponseBody
	public void saveVipSetMeal(Integer t_id, String t_setmeal_name, BigDecimal t_cost_price, BigDecimal t_money,
			int t_duration, int t_is_enable, int t_gold, int t_payType, String t_setMealName,
			HttpServletResponse response) {

		MessageUtil mu = this.vipSetMealService.saveVipSetMeal(t_id, t_setmeal_name, t_cost_price, t_money, t_duration,
				t_is_enable, t_gold, t_payType, t_setMealName);
