...
public interface CashValueSetMealService {
	 ...
	 * @return
	 */
	public MessageUtil addOrUpdateCashValue(Integer t_id, int t_project_type, int t_gold, BigDecimal t_money,
			int t_end_type, int t_is_enable, String t_describe,String t_setMelName);
